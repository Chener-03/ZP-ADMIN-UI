export default {
  ...
  'ID must be unique.': '编号必须填写并唯一',


  'The due date as an EL expression (e.g. ${someDate}) or an ISO date (e.g. 2015-06-26T09:54:00).':'作为EL表达式（例如${someDate}）或ISO日期（例如2015-06-26T09:54:00）的到期日。',
  'Open minimap': '打开小地图',
  'Close minimap': '关闭小地图',
