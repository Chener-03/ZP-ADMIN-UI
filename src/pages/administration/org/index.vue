  ...
  <t-row :gutter="20">
    <t-col :span="3">
      <t-card :bordered="false" :hover-shadow="true" style="border-radius: 10px;min-height: 790px">
        <t-row :gutter="15">
          ...
          <t-col :span="12">
            <t-input v-model="filterText" placeholder="关键词过滤"
                     style="margin-top: 5px"
                     clearable size="small" @input="onInput">
          ...
          <t-col :span="6" :md="3">
            <t-button theme="primary"  style="margin-top: 5px;width:100%" size="small"  @click="orgSetRef.onOrgNewClicked()">新增</t-button>
          </t-col>
          <t-col :span="6" :md="3">
            <t-button theme="primary"  style="margin-top: 5px;width:100%"  size="small"  @click="orgSetRef.onOrgEditClicked()">编辑</t-button>
          </t-col>
          <t-col :span="6" :md="3">
            <t-button theme="danger"  style="margin-top: 5px;width:100%"  size="small"  @click="onDeleteClick">删除</t-button>
          </t-col>
          <t-col :span="6" :md="3">
            <t-button theme="danger"  style="margin-top: 5px;width:100%"  size="small"  @click="onDisableClick">启|禁用</t-button>
          </t-col>
    ...
    <t-col :span="9">
      <OrgSetting
        ...
        :concurrent-node="concurrentNode"></OrgSetting>
    </t-col>
