...
export default {
  ...
  props: {
    ...
    plugins: {
      type: [String, Array],
      default: 'lists image media table wordcount save preview codesample code charmap link insertdatetime template fullscreen'
